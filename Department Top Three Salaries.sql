/*
    ...
    Example: For the above tables, your SQL query should return the following rows.
		+------------+----------+--------+
    ...
    Source: https://leetcode.com/discuss/54662/simple-solution-easy-to-understand
*/
