/*
    ...
    Example: For the above tables, your SQL query should return the following rows with the cancellation rate being rounded 
    ...
    Source: https://leetcode.com/discuss/52594/sharing-my-solution
*/
